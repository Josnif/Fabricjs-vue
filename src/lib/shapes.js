...
export const handleImageUpload = ({ file, canvas, shapeRef, syncShapeInStorage }) => {
...
export const modifyShape = ({ canvas, property, value, activeObjectRef, syncShapeInStorage }) => {
  const selectedElement = canvas.getActiveObject();

  if (!selectedElement || selectedElement?.type === "activeSelection") return;

  // Update the property of the selected element
  if (property === "width") {
